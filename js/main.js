const SPEC = {
  ...
  "description": "Steer creative projects with visible priorities, friction, and momentum.",
  "lede": "Track creator projects with audience, next move, momentum, and review timing so the best work keeps moving.",
  "heroEyebrow": "Creator workspace",
  "boardTitle": "Creator compass board",
  "boardSubtitle": "A local-first board for steering creator projects without losing momentum.",
  "accent": "Creative work compounds better when momentum, audience, and the next move stay visible on one compass.",
  "itemLabel": "creator project",
  "itemPluralLabel": "Creator projects",
  "labels": {
    "title": "Project",
    "note": "Project note",
  ...
  "textOne": {
    "label": "Audience",
    "default": "Who this project is for"
  },
  "textTwo": {
    "label": "Next move",
    "default": "What moves this forward"
  },
  "date": {
    "label": "Review date"
  },
  ...
  "defaults": {
    "note": "Describe what would make this project feel worth continuing for the next month."
  },
  "stats": {
    "totalLabel": "Projects",
    "motionLabel": "Active",
  ...
  "insights": {
    "topLabel": "Best creative bet",
    "dateLabel": "Next review",
    "metricLabel": "Highest momentum"
  },
  "queue": {
    "eyebrow": "Creator queue",
    "title": "What deserves energy next",
    "empty": "Published projects leave the active creator queue."
  },
  "mix": {
    "eyebrow": "Creator mix",
    "title": "Where the creative energy sits"
  },
  "emptyTitle": "No creator projects yet",
  "emptyBody": "Add channels, series, offers, and collabs you want to guide with more intention.",
  "actions": [
    {
      "id": "go-active",
      "label": "Go active",
      ...
      "days": 2,
      "fromToday": true,
      "toast": "Moved this project into active motion."
    },
    {
      "id": "raise-momentum",
      "label": "Raise momentum",
      "mode": "advance",
      "metricDelta": 1,
      "toast": "Raised momentum on this project."
    },
    {
      "id": "publish",
      ...
      "days": 0,
      "fromToday": true,
      "toast": "Marked this project published."
    }
  ],
  "theme": {
    "primary": "#c084fc",
  ...
  "items": [
    {
      ...
      "metric": 7,
      "textOne": "AI founders",
      "textTwo": "Draft the first 3 posts",
      "date": "2026-04-26",
      "note": "This could compound trust if the posts stay concrete and not self-congratulatory."
    },
    {
      "title": "Demo-led YouTube channel",
      "category": "Channel",
      "state": "Exploring",
      "score": 7,
      "effort": 5,
      "metric": 5,
      "textOne": "Long-form learners",
      "textTwo": "Test thumbnail style",
      "date": "2026-04-29",
      "note": "Potentially strong, but only if production drag stays manageable."
    },
    {
      "title": "Partner clip collaboration",
      "category": "Collab",
      "state": "Active",
      "score": 8,
      "effort": 2,
      "metric": 8,
      "textOne": "Shared audience",
      "textTwo": "Agree the story angle",
      "date": "2026-04-25",
      "note": "The overlap is good enough to justify a quick collaborative test."
    }
  ]
};
